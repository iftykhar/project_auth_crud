									...
									<div class="form-body">
										<form class="row g-3" method="POST" action="{{ route('register') }}">
											...
											<div class="col-sm-12">
												...
												<input name="uname" type="text" class="form-control" id="inputFirstName" placeholder="Enter User Name">
											</div>
											<div class="col-sm-6">
											...
											<div class="col-sm-12">
												...
												<input name="phone" type="text" class="form-control" id="inputLastName" placeholder="Type phone numer">
											</div>
											<div class="col-12">
